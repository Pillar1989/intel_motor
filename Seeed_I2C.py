...
class Seeed_I2C(object):

  @staticmethod
  def getPiRevision():
    "Gets the version number of the intel edison board"
    try:
  ...
  def getPiI2CBusNumber():
    ...
    return 1 if Seeed_I2C.getPiRevision() > 1 else 0
...
if __name__ == '__main__':
  try:
    bus = Seeed_I2C(address=0x48,busnum=1)
